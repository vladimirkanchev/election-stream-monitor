...
| `architecture-diagram-review` | Architecture-diagram flow, boundaries, and stage honesty | 92 | Low; medium for external communication | diagram scenarios and boundary pairs | none |
...
| Broad security-surface review | archived skill; reactivate before public exposure or broad trust review | security scenarios and risky-change routing |
